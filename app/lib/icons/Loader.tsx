...
const IconLoader = ({isOnLoader}: IconLoaderProps) => (
  <svg id="logo" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg" className={'w-20'}>
    <g id="A" className={clsx(isOnLoader ? 'opacity-0' : 'opacity-100')}>
      <path
        ...
        45.6H79.9381L102.546 96H94.0501ZM71.4421 63.168L65.3941
        76.416H85.2661L79.0741 62.88C78.4501 61.344 77.8261 59.832 77.2021
    ...
    <path
      ...
      46.1603V103.84C134.952 107.412 133.046 110.714 129.952 112.5L80
      141.34C76.906 143.126 73.094 143.126 70 141.34L20.0481 112.5C16.9541
